        ...
        <section className="content-wrapper">
            <div className="container-fluid">
                ...
                <div className="pt-70 pb-md-50 pb-150">
                    <h2 className="text-4xl fw-bold text-center color-palette-1 mb-10 text-danger">Oops! Not Found</h2>
                ...
                <div className="row">
                  <div className="col-12 text-center">
                    <button href="/" type="submit" class="btn btn-primary ">Dashboard</button>
                  </div>
                </div>
            </div>
        </section>
